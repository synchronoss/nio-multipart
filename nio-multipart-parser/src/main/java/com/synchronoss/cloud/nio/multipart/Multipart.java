...
import static com.synchronoss.cloud.nio.multipart.DefaultPartBodyByteStoreFactory.DEFAULT_MAX_THRESHOLD;
import static com.synchronoss.cloud.nio.multipart.DefaultPartBodyByteStoreFactory.DEFAULT_TEMP_FOLDER;
import static com.synchronoss.cloud.nio.multipart.NioMultipartParser.DEFAULT_BUFFER_SIZE;
import static com.synchronoss.cloud.nio.multipart.NioMultipartParser.DEFAULT_HEADERS_SECTION_SIZE;
import static com.synchronoss.cloud.nio.multipart.NioMultipartParser.DEFAULT_MAX_LEVEL_OF_NESTED_MULTIPART;
...
public class Multipart {
    ...
    public static class Builder {
        ...
        private int headersSizeLimit = DEFAULT_HEADERS_SECTION_SIZE;
        private int nestedMultipartsAllowed = DEFAULT_MAX_LEVEL_OF_NESTED_MULTIPART;
        private String tempFolder = DEFAULT_TEMP_FOLDER;
        private int bodySizeThreshold = DEFAULT_MAX_THRESHOLD;
