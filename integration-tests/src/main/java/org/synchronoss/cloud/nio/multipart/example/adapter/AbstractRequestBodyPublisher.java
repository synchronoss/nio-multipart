 ...
 */
abstract class AbstractRequestBodyPublisher implements Publisher<byte[]> {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractRequestBodyPublisher.class);
    ...
    private enum State {
        ...
        UNSUBSCRIBED {
            @Override
            void subscribe(AbstractRequestBodyPublisher publisher, Subscriber<? super byte[]> subscriber) {
